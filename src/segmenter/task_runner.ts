...
import {InferenceCalculatorOptions} from './inference_calculator_pb';
import {CalculatorGraphConfig} from './calculator_pb';
import {Acceleration} from './acceleration_pb';
import {BaseOptions as BaseOptionsProto} from './base_options_pb';

import * as external_file_pb from './external_file_pb.js';
const ExternalFile = (external_file_pb as any).default.ExternalFile;
import {
  BaseOptions,
  TaskRunnerOptions,
} from './task_runner_options.js';
import {streamToUint8Array} from './model_loading_utils.js';
import {
  FileLocator,
  GraphRunner,
