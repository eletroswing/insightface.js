...
import {CalculatorOptions} from './calculator_options_pb';

import {BaseOptions as BaseOptionsProto} from './base_options_pb';
import {TensorsToSegmentationCalculatorOptions} from './tensors_to_segmentation_calculator_pb';
import {ImageSegmenterGraphOptions as ImageSegmenterGraphOptionsProto} from './image_segmenter_graph_options_pb';
import {SegmenterOptions as SegmenterOptionsProto} from './segmenter_options_pb'; //transformar do proto
...
import {
  VisionGraphRunner,
  VisionTaskRunner,
} from './vision_task_runner.js';
import {
  ImageSource,
  WasmModule,
} from './graph_runner.js';
import {ImageSegmenterOptions} from './image_segmenter_options.js';
import {ImageSegmenterResult} from './image_segmenter_result.js';

export * from './image_segmenter_options.js';
export * from './image_segmenter_result.js';
